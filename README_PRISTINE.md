...
How to contribute, build and release are outlined in [CONTRIBUTING.md](CONTRIBUTING.md) and [RELEASING.md](RELEASING.md) respectively. Commits in this repository follow the [CONVENTIONAL_COMMITS.md](CONVENTIONAL_COMMITS.md) specification.